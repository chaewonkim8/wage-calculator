document.getElementById("calculatorForm").addEventListener("submit", function (event) {
  ...
  // Update result elements with integer format
  document.getElementById("result_reckonable_years").textContent = Math.floor(reckonableYears);
  document.getElementById("result_days_of_service").textContent = daysOfService;
  document.getElementById("result_long_service_payment").textContent = Math.floor(longServicePayment);
});